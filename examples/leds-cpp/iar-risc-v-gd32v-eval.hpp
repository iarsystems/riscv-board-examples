/*!
    \file    iar-risc-v-gd32v-eval.hpp
    \brief   definitions for IAR RISC-V GD32V Eval board hardware resources

    \version 20210331, Temporary fix to use <stdbool.h> when not on C++
*/
...
#ifndef __IAR_RISCV_GD32V_EVAL_HPP
#define __IAR_RISCV_GD32V_EVAL_HPP
